    ...
    mutations: {
        ...
        resetProjectState(state, payload = null) {
            (state.project.title = null),
                (state.project.price = null),
                (state.project.description = null),
                (state.project.cover = null),
                (state.project.left = null),
                (state.project.right = null),
                (state.project.front = null),
                (state.project.back = null),
                (state.project.dld = null),
                (state.project.video = null),
                (state.project.bathrooms = null),
                (state.project.bedrooms = {}),
                (state.project.completion_date = null),
                (state.project.starting_date = null),
                (state.project.area = null),
                (state.project.stores = null),
                (state.project.appartments_in_store = null),
                (state.project.number_of_unites_available = null),
                (state.project.user_id = null),
                (state.project.developer_id = null),
                (state.project.location_id = null),
                (state.project.type_id = null),
                (state.project.locationLink = null),
                (state.project.availableUnites = []),
                (state.project.amenities = []),
                (state.project.comunityAmenities = []),
                (state.project.floorPlans = {}),
                (state.project.floor3ds = {}),
                (state.project.images = []),
                (state.project.paymenPlans = []),
                (state.project.featured = null),
                (state.project.status_id = null),
                (state.project.plansArray = []),
                (state.project.plans3dArray = []),
                (state.project.installments = null);
        },
        setProjectState(state, payload) {
            ...
            state.project.number_of_unites_available =
                payload.number_of_unites_available;
