...
export default {
    ...
    mounted(){
        ...
        apiFront.get('/projects/featured')
        .then((response) => {
            // handle success
            console.log(response.data);
